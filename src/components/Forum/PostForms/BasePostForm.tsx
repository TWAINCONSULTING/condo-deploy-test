    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end gap-3 border-t border-gray-200 pt-4">
        ...
        <div className="relative">
          <div className="flex">
            <Button type="submit" className="rounded-r-none px-6">
              Publiser
            </Button>
            <button
              type="button"
              className="flex items-center px-2 bg-blue-600 hover:bg-blue-700 text-white border-l border-blue-500 rounded-r-lg"
            ...
            <div className="absolute right-0 mt-1 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-10">
              <button
                ...
                className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-50 ${
                  form.scope === 'building' ? 'text-blue-600' : 'text-gray-700'
                }`}
              >
              ...
              <button
                ...
                className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-50 ${
                  form.scope === 'area' ? 'text-blue-600' : 'text-gray-700'
                }`}
              >
                Publiser i området
              </button>
